...
// it is the browser window object 
// 3. Explain why "this" is different when an arrow function is used.
// the "this" keyword is not reset inside an arrow function, so it is equivalent to the "this" for the enclosing scope, which is the global scope right now 